...
It looks like the normal approximation is good enough for us for the first model.
...
Now we will use this in our modeling below.
...
plot(prob[,2],type="l",ylim=c(0,1), main="Chance of Univariate ARMA Dominating",lwd=2,ylab="posterior probability")
# lines(Z==2,col=2,lwd=2)
```
