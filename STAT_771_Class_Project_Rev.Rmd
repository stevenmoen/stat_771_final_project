...
```{r}
hmm_master = function(var_level, year, print_best_mods = 1, path = "/Users/stevenmoen/Documents/GitHub/CAViaR_MS_thesis/Data_Export/SPY_all_ETF_runs/"){
  # First, pull the data
  da1 = import_dat(var_level = var_level, year = year, path = filepath)
  ...
  # Fourth, find the optimal univariate parameters
  # uv_cav_fit = function(input_df){
  opt_uv_param = uv_cav_fit(small_da)
  # Fifth, find the optimal multivariate parameters
