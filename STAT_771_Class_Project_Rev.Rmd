...
#'
#' @param var_level - the VaR level used to pull in theesis data
#' @param year - the year of thesis data to pull in
#' @param t_prob - the probability of transition
#' @param prior_prob - the prior probability
#' @param irr_dist - the irrational distribution. The default is Gunmbel
#' @param rat_dist - the rational distribution. The default is Normal
#' @param print_best_mods - do you print the best models?
#' @param path - filepath to where the all ETF runs are stored. Don't modify this without a good reason.
#'
#' @return - a list of the probabilities, the alphas, and the betas
#' @export
#'
#' @examples - res_2008_1pc_1tp = hmm_master(1, 2008, t_prob = 0.01)
hmm_master = function(var_level, year, t_prob = 0.1, prior_prob = 0.5, irr_dist = "Gumbel", rat_dist = "Normal",
                      print_best_mods = 1, path = "/Users/stevenmoen/Documents/GitHub/CAViaR_MS_thesis/Data_Export/SPY_all_ETF_runs/"){
  # First, pull the data
  da1 = import_dat(var_level = var_level, year = year, path = path)
  # Second,  pick the best
  best = pick_best(da1$losses)
  # Third, subset the data
  small_da = small_df_fn(best, da1$preds, print_best_mods = print_best_mods)
  # Fourth, find the optimal univariate parameters - the irrational ones
  # uv_cav_fit = function(input_df){
  opt_uv_param = uv_cav_fit(small_da)
  # Fifth, find the optimal multivariate parameters - the rational ones
  opt_mv_param = mv_cav_fit(small_da)
  # Combine both into a nice little thing
  # Next, I will feed these into the hmm_fit function, deciding to choose the params based on K-L divergence
  out = hmm_fit(input_df = small_da, t_prob = t_prob, prior_prob = prior_prob, irr_dist = irr_dist,
                rat_dist = rat_dist, rat_opt_param = opt_mv_param, irr_opt_param = opt_uv_param, var_level = var_level)
  # Return out
  return(out)
  # hmm_fit = function(input_df, t_prob, prior_prob, irr_dist = "Gumbel", rat_dist = "Normal"){
  # Stopping point for 1/17/2021
  # JUNK
...
```{r}
res_2008_1pc_1tp = hmm_master(1, 2008, t_prob = 0.01)
res_2008_5pc_1tp = hmm_master(5, 2008, t_prob = 0.01)
res_2008_10pc_1tp = hmm_master(10, 2008, t_prob = 0.01)
...
```{r}
res_2008_1pc_5tp = hmm_master(1, 2008, t_prob = 0.05)
res_2008_5pc_5tp = hmm_master(5, 2008, t_prob = 0.05)
res_2008_10pc_5tp = hmm_master(10, 2008, t_prob = 0.05)
```
...
```{r}
res_2008_1pc_10tp = hmm_master(1, 2008, t_prob = 0.10)
res_2008_5pc_10tp = hmm_master(5, 2008, t_prob = 0.10)
res_2008_10pc_10tp = hmm_master(10, 2008, t_prob = 0.10)
```

### 20% TP

```{r}
res_2008_1pc_20tp = hmm_master(1, 2008, t_prob = 0.20)
res_2008_5pc_20tp = hmm_master(5, 2008, t_prob = 0.20)
res_2008_10pc_20tp = hmm_master(10, 2008, t_prob = 0.20)
```

### 33% TP

```{r}
res_2008_1pc_33tp = hmm_master(1, 2008, t_prob = 0.33)
res_2008_5pc_33tp = hmm_master(5, 2008, t_prob = 0.33)
res_2008_10pc_33tp = hmm_master(10, 2008, t_prob = 0.33)
```
...
```{r}
res_2010_1pc_10tp = hmm_master(1, 2010, t_prob = 0.10)
res_2010_5pc_10tp = hmm_master(5, 2010, t_prob = 0.10)
res_2010_10pc_10tp = hmm_master(10, 2010, t_prob = 0.10)
```
...
```{r}
res_2014_1pc_10tp = hmm_master(1, 2014, t_prob = 0.10)
res_2014_5pc_10tp = hmm_master(5, 2014, t_prob = 0.10)
res_2014_10pc_10tp = hmm_master(10, 2014, t_prob = 0.10)
```
...
```{r}
res_2016_1pc_10tp = hmm_master(1, 2016, t_prob = 0.10)
res_2016_5pc_10tp = hmm_master(5, 2016, t_prob = 0.10)
res_2016_10pc_10tp = hmm_master(10, 2016, t_prob = 0.10)
```
