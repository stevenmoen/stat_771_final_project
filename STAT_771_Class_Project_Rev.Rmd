...
hmm_fit = function(input_df, t_prob, prior_prob, rat_opt_param, irr_opt_param, irr_dist = "Gumbel", rat_dist = "Normal"){
  # Set a value of T and K
  T = nrow(input_df)
  K = ncol(input_df) - 1
...
```{r}
out = hmm_fit(input_df = small_df, t_prob = 0.1, prior_prob = 0.5, irr_dist = "Gumbel", rat_opt_param = norm_param_df2, irr_opt_param = ev_param_df)
# head(out)
# rowSums(out)
# index(small_df)
...
hmm_master = function(var_level, year, t_prob = 0.1, prior_prob = 0.5, irr_dist = "Gumbel", rat_dist = "Normal",
  ...
  out = hmm_fit(input_df = small_da, t_prob = t_prob, prior_prob = prior_prob, irr_dist = irr_dist,
                rat_dist = rat_dist, rat_opt_param = opt_mv_param, irr_opt_param = opt_uv_param)
  # Return out
  return(out)
...
```{r}
res_2008_1pc_10tp = hmm_master(1, 2010, t_prob = 0.10)
res_2008_5pc_10tp = hmm_master(5, 2010, t_prob = 0.10)
res_2008_10pc_10tp = hmm_master(10, 2010, t_prob = 0.10)
```
...
```{r}
res_2008_1pc_10tp = hmm_master(1, 2014, t_prob = 0.10)
res_2008_5pc_10tp = hmm_master(5, 2014, t_prob = 0.10)
res_2008_10pc_10tp = hmm_master(10, 2014, t_prob = 0.10)
```
...
```{r}
res_2008_1pc_10tp = hmm_master(1, 2016, t_prob = 0.10)
res_2008_5pc_10tp = hmm_master(5, 2016, t_prob = 0.10)
res_2008_10pc_10tp = hmm_master(10, 2016, t_prob = 0.10)
```
